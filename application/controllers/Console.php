...
class Console extends CI_Controller
{
    ...
    public function index()
    {
        // 頁面資訊
        $view_data = array(
            'title' => "Restube - Console Dashboard",
            'path' => 'console/index',
            'page' => 'dashboard.php',
            'menu' => 'dashboard',
        );
    ...
    public function category_list()
    {
        // 頁面資訊
        $view_data = array(
            'title' => "Restube - Console Category",
